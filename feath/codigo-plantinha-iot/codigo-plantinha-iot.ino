...
char serverAddress[] = "https://7192-137-184-129-157.sa.ngrok.io";  // server address
int port = 443;
...
void platinhaStatus(String status){
  ...
  options.body = "{\"status\":\""+(String)status+"\"}";
  Serial.println("{\"status\":\""+(String)status+"\"}");
   delay(2000);
  // read the status code and body of the response
  //Response response = fetch("https://7192-137-184-129-157.sa.ngrok.io/api/v1/sendStatus", options);
  Response response = fetch("http://localhost:3000/api/v1/sendStatus", options);
